...
class Object_detect():
    ...
    def __init__(self, camera_x = -13, camera_y = 335):
        ...
        self.avg_angles= [
            ...
            [17.4, -10.43, -167.51, 2.81, -96.24, -47.63],
    ...
    def run(self):
        ...
        self.mc.send_angles([-40.31, 2.02, -10.72, -0.08, 80, -54.84], 50)
        time.sleep(3)
    ...
    def get_position(self, x, y):
        ...
        return ((-x - self.c_x) * self.ratio + self.camera_y), ((y - self.c_y) * self.ratio + self.camera_x)
