...
![Softeware Page](resources/img_depict/software_page_en.png "Software Page")

## 1. Language Switch

Select Chinese and English to switch the corresponding language.

![Language Choose](resources/img_depict/language_choices_en.png "Choose Language")

## 2. Laser Radar

![Radar Open](resources/img_depict/radar_open_en.png "Open Radar")

![Radar Close](resources/img_depict/radar_close_en.png "Close Radar")
...
![Basic Control](resources/img_depict/basic_control_en.png "Basic Control")
...
![Map Navigation](resources/img_depict/map_navi_en.png "Map and navigation")
...
![Build Map](resources/img_depict/build_map_en.png  "Build Map")
...
Click the drop-down box to select the Gmapping mapping method, and click the "Open Mapping" button to start mapping.
   ...
   2. Select the opened keyboard terminal and use the keyboard to control the car. The rviz space will build the map as the car moves. The trajectory is shown in the figure:  ![Gmapping Map](resources/img_depict/gmapping_rviz.png  "Gmapping Map")

#### Cartographer

Click the drop-down box to select the Gmapping mapping method, and click the "Open Mapping" button to start mapping.

   1. Click the button and it will open a new terminal. If the terminal keeps scrolling the output data, the cartographer build file is successfully opened, and the terminal displays the following status：   ![Cartographer Map](resources/img_depict/cartographer_terminal.png)
   2. When the code runs successfully, rviz will be opened, and the map and lidar information will be displayed in rviz, and the red arrow is the direction of the car. The interface is shown in the figure.   ![Cartographer Map](resources/img_depict/cartograph_rviz.jpg)
   3. Select the opened keyboard terminal and use the keyboard to control the car. The rviz space will build the map as the car moves. The trajectory is shown in the figure:  ![Cartographer Track](resources/img_depict/catograph_rviz2.jpg)
...
![Save Map](resources/img_depict/save_map_en.png "Save Map")
...
![Map Navigation](resources/img_depict/navagation_en.png "Map Navigation")
...
![LED Light](resources/img_depict/led_light_en.png "LED Light")
...
![Testing Function](resources/img_depict/testing_en.png "Testing Function")
...
### 6.6 Restore
![Restore Function](resources/img_depict/restore_en.png "Restore FUnction")  
...
![Log Area](resources/img_depict/log_area_en.png "Log Area")
...
![Status Detecting](resources/img_depict/status_add_en.png "Status Information")
