...
class myAGV_windows(QMainWindow):
    ...
    def __init__(self):
        ...
        self.myagv=None
        # self.myagv = MyAgv("/dev/ttyAMA2", 115200) #todo update monitor
        self.st=None
        self.status=None
    ...
    def language_selection(self,lang):
        ...
        if lang == "zh_CN" or lang == "中文":
            print("=====Chinese")
            self.translator.load("D:\projects\cc\AGV_UI\\translation\operations_lang.qm")
...
class status_detect(QThread):
    ...
    def get_info(self):
        ...
        print(battery_1,battery_2,"batterys")
        ...
        print(power_2,power_1,"thttththt")
        time.sleep(0.2)
