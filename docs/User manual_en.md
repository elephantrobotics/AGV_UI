...
![Softeware Page](img_depict/software_page_en.png "Software Page")

## 1. Language Switch

Select Chinese and English to switch the corresponding language.

![Language Choose](img_depict/language_choices_en.png "Choose Language")

## 2. Laser Radar

![Radar Open](img_depict/radar_open_en.png "Open Radar")

![Radar Close](img_depict/radar_close_en.png "Close Radar")
...
3. A new terminal appears on the desktop, indicating that the radar is successfully opened.
   ![Radar Open](img_depict/radar_open_terminal.png "Open Radar")
...
![Basic Control](img_depict/basic_control_en.png "Basic Control")
...
### 3.1 Keyboard Control
   ...
   ![Keyboard terminal](img_depict/keyboard_terminal.png "Keyboard terminal")  
...
#### 2.1 Handle-Letter type
   ...
   ![JoyStick Alphabet](img_depict/joystick_terminal.jpg  "JoyStick Alphabet")
   ...
   ![JoyStick Alphabet](img_depict/joystick_alphabet.jpg)

---

#### 2.2 Handle-Digital type

   ![JoyStick Number](img_depict/joystick_terminal.jpg "JoyStick Number")

   >There are 7 buttons on the handle to control the car movement, as shown in the picture, 1~4 control the car forward and backward and left and right movement, 5 control the car counterclockwise rotation, 6 control the car clockwise rotation, 7 is the stop button.

   ![JoyStick Number](img_depict/joystick_number.png "JoyStick Number")

## 4. Map and Navigation

![Map Navigation](img_depict/map_navi_en.png "Map and navigation")
...
![Build Map](img_depict/build_map_en.png  "Build Map")
...
Click the drop-down box to select the Gmapping mapping method, and click the "Open Mapping" button to start mapping.
   ...
   2. Select the opened keyboard terminal and use the keyboard to control the car. The rviz space will build the map as the car moves. The trajectory is shown in the figure:  ![Gmapping Map](img_depict/gmapping_rviz.png  "Gmapping Map")

#### Cartographer

Click the drop-down box to select the Gmapping mapping method, and click the "Open Mapping" button to start mapping.

   1. Click the button and it will open a new terminal. If the terminal keeps scrolling the output data, the cartographer build file is successfully opened, and the terminal displays the following status：   ![Cartographer Map](img_depict/cartographer_terminal.png)
   2. When the code runs successfully, rviz will be opened, and the map and lidar information will be displayed in rviz, and the red arrow is the direction of the car. The interface is shown in the figure.   ![Cartographer Map](img_depict/cartograph_rviz.jpg)
   3. Select the opened keyboard terminal and use the keyboard to control the car. The rviz space will build the map as the car moves. The trajectory is shown in the figure:  ![Cartographer Track](img_depict/catograph_rviz2.jpg)
...
![Save Map](img_depict/save_map_en.png "Save Map")
...
![Save map terminal](img_depict/save_map.png)
...
![Map Navigation](img_depict/navagation_en.png "Map Navigation")
...
![Run launch File1](img_depict/run_launch1.jpg)

1. Click on "2D Nav Goal" in the top toolbar.

![Run launch File3](img_depict/run_launch3.png)
...
![Run launch File4](img_depict/run_launch4.jpg)
...
![LED Light](img_depict/led_light_en.png "LED Light")
...
![Testing Function](img_depict/testing_en.png "Testing Function")
...
### 6.6 Restore
![Restore Function](img_depict/restore_en.png "Restore FUnction")  
...
![Log Area](img_depict/log_area_en.png "Log Area")
...
![Status Detecting](img_depict/status_add_en.png "Status Information")
